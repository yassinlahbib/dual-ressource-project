...
if __name__ == "__main__":
    nb_jobs, max_nb_operations, max_nb_sub_operations, nb_workers, levels_workers, difficulty_jobs, difficulty_operations, processing_time_operations, constraints_precedence_operations, constraints_precedence_sub_operations = read_file("data_2.test")
